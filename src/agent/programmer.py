...
prompts = Prompts(role=Role.PROGRAMMER)
...
def fetch_completion(data_entry, times: int = 1):
    ...
    chatter = Chatter(system_message="You are a software programmer.")
    global prompts
    ...
    for i in range(times):
        # NOTE: The below while mesoop is a dangerous code block. ==> chê
        while True:
...
"""
    ...
    logging.info(data_entry["completion_list"])
